...
git update-index --no-skip-worktree login/*
...
git update-index --no-skip-worktree ../challenges/1_Railroad/t0/scorebot/secrets.py
git update-index --no-skip-worktree ../challenges/2_Power-Grid/t0/scorebot/secrets.py
git update-index --no-skip-worktree ../challenges/1_Railroad/t0/authorized_keys
