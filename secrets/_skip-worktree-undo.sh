...
git update-index --no-skip-worktree ../challenges/0_Smart-Home/_firmware/wap/config.ino
git update-index --no-skip-worktree ../challenges/2_Power-Grid/_firmware/wap/config.ino
